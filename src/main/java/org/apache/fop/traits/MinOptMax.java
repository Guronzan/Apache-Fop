 ...
 * {@link LengthRangeProperty LengthRange} or {@link SpaceProperty Space} type
 * property value.
 * <p/>
...
public final class MinOptMax implements Serializable {
     ...
     *             operand
     */
    public MinOptMax minus(final MinOptMax operand) {
     ...
     */
    public MinOptMax mult(final int factor) {
        if (factor < 0) {
