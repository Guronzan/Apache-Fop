...
public class FullyQualifiedNameTriplet extends AbstractTriplet {
    ...
    /**
     * This GID replaces the first parameter in the structured field that
     * contains a GID name.
     */
    ...
    /**
     * The triplet contains a reference to a data-object font file that defines
     * a base font.
     */
    ...
    /**
     * The triplet contains a reference to a begin structured field associated
     * with a resource; or contains a GID reference to a coded font.
     */
    public static final byte TYPE_BEGIN_RESOURCE_OBJECT_REF = (byte) 0x84;

    /**
     * The triplet contains a GID reference to a code page that specifies the
     * code points and graphic character names for a coded font.
     */
    public static final byte TYPE_CODE_PAGE_NAME_REF = (byte) 0x85;

    /**
     * The triplet contains a GID name reference to a font character set that
     * specifies a set of graphics characters.
     */
    ...
    /**
     * The triplet contains a GID reference to a begin medium map structured
     * field.
     */
    public static final byte TYPE_BEGIN_MEDIUM_MAP_REF = (byte) 0x8D;

    /**
     * The triplet contains a GID reference to a coded font, which identifies a
     * specific code page and a specific font character set.
     */
    public static final byte TYPE_CODED_FONT_NAME_REF = (byte) 0x8E;

    /**
     * The triplet contains a GID reference to a begin document index structured
     * field.
     */
    ...
    /**
     * The triplet contains a GID reference to an index element structured
     * field.
     */
    ...
    /**
     * The triplet contains a reference to a resource used by a data object. The
     * GID may be a filename or any other identifier associated with the
     * resource and is used to located the resource object in the resource
     * hierarchy. The data object that uses the resource may or may not be
     ...
     */
    public FullyQualifiedNameTriplet(final byte type, final byte format,
            final String fqName) {
