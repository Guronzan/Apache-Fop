...
public class ImageObject extends AbstractDataObject {
    ...
    public void setViewport(final AFPDataObjectInfo dataObjectInfo) {
        ...
        } else if (MimeConstants.MIME_AFP_IOCA_FS45.equals(imageObjectInfo
                .getMimeType())) {
            imageDataDescriptor
     ...
     */
    @Deprecated
    public void setIDEColorModel(final byte colorModel) {
     ...
     * @deprecated Use {@link IDEStructureParameter#setSubtractive(boolean)}
     *             instead.
     */
    @Deprecated
