...
public class AFPResourceLevelDefaults {
    ...
    private static final Map<String, Byte> RESOURCE_TYPE_NAMES = new HashMap<>();
    ...
    private final Map<Byte, AFPResourceLevel> defaultResourceLevels = new HashMap<>();
     ...
     *            the resource level
     */
    public void setDefaultResourceLevel(final String type,
    ...
    public AFPResourceLevel getDefaultResourceLevel(final byte type) {
        AFPResourceLevel result = this.defaultResourceLevels
                .get(new Byte(type));
        if (result == null) {
     ...
     */
    public void mergeFrom(final AFPResourceLevelDefaults other) {
        for (final Entry<Byte, AFPResourceLevel> entry : other.defaultResourceLevels
                .entrySet()) {
            final Byte type = entry.getKey();
            final AFPResourceLevel level = entry.getValue();
