...
public class AFPResourceLevelDefaults {
    ...
    public void mergeFrom(final AFPResourceLevelDefaults other) {
        final Iterator iter = other.defaultResourceLevels.entrySet().iterator();
        while (iter.hasNext()) {
            final Map.Entry entry = (Map.Entry) iter.next();
            final Byte type = (Byte) entry.getKey();
            final AFPResourceLevel level = (AFPResourceLevel) entry.getValue();
