...
public class DTDEntityResolver implements EntityResolver {
    ...
    /**
     * Resolve the combination of system and public identifiers. If this
     * resolver recognises the publicId, it will handle the resolution from the
     * classpath, otherwise it will return null and allow the default resolution
     * to occur.
     *
     * @param publicId
     *            the public identifier to use
     * @param systemId
    ...
    public InputSource resolveEntity(final String publicId,
        ...
        final InputSource inputSource = new InputSource(resource.openStream());
    ...
    private URL getResource(final String resourcePath) {
        ...
        final URL resource = cl.getResource(resourcePath);
        if (resource == null) {
