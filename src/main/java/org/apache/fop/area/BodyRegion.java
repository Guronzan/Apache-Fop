...
public class BodyRegion extends RegionReference {
     ...
     *
     */
    private static final long serialVersionUID = -3038877530693717367L;
    ...
    @Override
    public Object clone() {
        final BodyRegion br = new BodyRegion(getRegionClass(), getRegionName(),
                this.regionViewport, getColumnCount(), getColumnGap());
        br.setCTM(getCTM());
        br.setIPD(getIPD());
