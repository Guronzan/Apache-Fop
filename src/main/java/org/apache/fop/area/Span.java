...
public class Span extends Area {
    ...
    /**
     * Sets the writing mode traits for the main reference area of this span
     * area.
     * 
     * @param wmtg
     *            a WM traits getter
    ...
    public void setWritingModeTraits(final WritingModeTraitsGetter wmtg) {
        ...
        case Constants.EN_RL:
            setBidiLevel(1);
            for (final NormalFlow normalFlow : this.flowAreas) {
                normalFlow.setBidiLevel(1);
            }
            break;
        default:
            resetBidiLevel();
            for (final NormalFlow normalFlow : this.flowAreas) {
                normalFlow.resetBidiLevel();
            }
            break;
        }
    }
