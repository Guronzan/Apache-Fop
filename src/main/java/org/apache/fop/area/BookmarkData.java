...
public class BookmarkData extends AbstractOffDocumentItem implements Resolvable {
    ...
    private final Map<String, List<Resolvable>> unresolvedIDRefs = new HashMap<>();
    ...
    public String[] getIDRefs() {
        return this.unresolvedIDRefs.keySet().toArray(
    ...
    public void resolveIDRef(final String id, final List<PageViewport> pages) {
        ...
        final List<Resolvable> refs = this.unresolvedIDRefs.get(id);
        if (refs != null) {
            for (final Resolvable res : refs) {
