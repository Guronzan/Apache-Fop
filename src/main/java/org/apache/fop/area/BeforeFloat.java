...
/**
 * The before-float-reference-area optionally generated by an fo:region-body. It
 * has an optional separator and before float block children. See fo:region-body
 * definition in the XSL Rec for more information.
 */
public class BeforeFloat extends BlockParent {
     ...
     */
    public void setSeparator(final Block sep) {
        this.separator = sep;
    }
    ...
    /**
     * Get the height of this before float. It gets the height of the children
     * and if there is a separator its height is also added.
     *
