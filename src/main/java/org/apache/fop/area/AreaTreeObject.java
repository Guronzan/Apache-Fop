...
/* $Id: AreaTreeObject.java 1311120 2012-04-08 23:48:11Z gadams $ */
...
public abstract class AreaTreeObject implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        if (this.foreignAttributes != null) {
            ato.foreignAttributes = (Map<QName, String>) ((HashMap<QName, String>) this.foreignAttributes)
                    .clone();
        }
        if (this.extensionAttachments != null) {
            ato.extensionAttachments = (List<ExtensionAttachment>) ((ArrayList<ExtensionAttachment>) this.extensionAttachments)
                    .clone();
        }
        return ato;
    }
