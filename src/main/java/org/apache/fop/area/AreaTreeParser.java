    ...
    private static class Handler extends DefaultHandler {
        ...
        private final class StructureTreeBuilderWrapper extends
            ...
            public void endDocument() throws SAXException {
                super.endDocument();
                startAreaTreeElement("pageSequence",
        ...
        private Area findAreaType(final Class clazz) {
            if (this.areaStack.size() > 0) {
                ...
                Object obj = null;
                while (pos >= 0
                        && !clazz.isInstance(obj = this.areaStack.get(pos))) {
                    pos--;
                }
                if (pos >= 0) {
                    return (Area) obj;
        ...
        private class RegionBodyMaker extends AbstractMaker {
            ...
            public void startElement(final Attributes attributes) {
                ...
                body = new BodyRegion(Constants.FO_REGION_BODY, regionName, rv,
        ...
        private class InlineMaker extends AbstractMaker {
            ...
            public void startElement(final Attributes attributes) {
                ...
                inl.setOffset(XMLUtil
                        .getAttributeAsInt(attributes, "offset", 0));
        ...
        private class TextMaker extends AbstractMaker {
            ...
            public void startElement(final Attributes attributes) {
                ...
                text.setBaselineOffset(XMLUtil.getAttributeAsInt(attributes,
                        "baseline", 0));
                text.setOffset(XMLUtil.getAttributeAsInt(attributes, "offset",
                        0));
        ...
        private class WordMaker extends AbstractMaker {
            ...
            public void endElement() {
                ...
                final WordArea word = new WordArea(Handler.this.content
                        .toString().trim(), offset, letterAdjust);
        ...
        private class SpaceMaker extends AbstractMaker {
            ...
            public void endElement() {
                ...
                if (Handler.this.content.position() > 0) {
                    ...
                    final SpaceArea space = new SpaceArea(
                            Handler.this.content.charAt(0), offset, adjustable);
                    final AbstractTextArea text = getCurrentText();
        ...
        private class LeaderMaker extends AbstractMaker {
            ...
            public void startElement(final Attributes attributes) {
                ...
                leader.setOffset(XMLUtil.getAttributeAsInt(attributes,
                        "offset", 0));
        ...
        private class ViewportMaker extends AbstractMaker {
            ...
            @Override
            public void startElement(final Attributes attributes) {
                final Viewport viewport = new Viewport(null);
                ...
                viewport.setClip(XMLUtil.getAttributeAsBoolean(attributes,
                        "clip", false));
                viewport.setOffset(XMLUtil.getAttributeAsInt(attributes,
                        "offset", 0));
        ...
        private void setPtr(final Area area, final Attributes attributes) {
