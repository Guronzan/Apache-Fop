...
@Slf4j
 public class RenderPagesModel extends AreaTreeModel {
      ...
      */
     protected List<PageViewport> prepared = new java.util.ArrayList<>();

     private final List<OffDocumentItem> pendingODI = new java.util.ArrayList<>();
     private final List<OffDocumentItem> endDocODI = new java.util.ArrayList<>();
