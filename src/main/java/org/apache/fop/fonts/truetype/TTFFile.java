...
public class TTFFile {
    ...
    private boolean readCMAP() throws IOException {
        ...
        this.unicodeMappings = new TreeSet<>();
    ...
    // CSOK: MethodLength
    private boolean readUnicodeCmap(final long cmapUniOffset,
            final int encodingID) throws IOException {
    ...
    public void printStuff() {
        ...
        if (this.italicAngle % 0x10000 > 0) {
            log.info("." + (short) (this.italicAngle % 0x10000 * 1000)
                    / 0x10000);
        }
