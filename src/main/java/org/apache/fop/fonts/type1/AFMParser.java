...
public class AFMParser {
    ...
    static {
        ...
        PARSE_MODE_CHANGES.put(START_CHAR_METRICS, new Integer(
                PARSE_CHAR_METRICS));
     ...
     */
    public AFMFile parse(final InputStream in, final String afmFileName)
            throws IOException {
     ...
     *             if an I/O error occurs
     */
    public AFMFile parse(final BufferedReader reader, final String afmFileName)
            throws IOException {
    ...
    private String parseCharMetrics(final String line,
            final Stack<Object> stack, final String afmFileName)
            throws IOException {
        ...
        final CharMetricsHandler charMetricsHandler = CharMetricsHandler
                .getHandler(VALUE_PARSERS, encoding);
        final AFMCharMetrics chm = charMetricsHandler.parse(trimmedLine, stack,
                afmFileName);
    ...
    private abstract static class BeanSetter extends AbstractValueHandler {
        ...
        protected void setValue(final Object target, final Class<?> argType,
                final Object value) {
            final Class<?> c = target.getClass();

            try {
                final Method mth = c.getMethod(this.method, argType);
    ...
    private static class BooleanSetter extends AbstractValueHandler {
        ...
        public void parse(final String line, final int startpos,
            ...
            final Object target = getContextObject(stack);
            final Class<?> c = target.getClass();
            try {
                final Method mth = c.getMethod(this.method, boolean.class);
                mth.invoke(target, b);
            } catch (final NoSuchMethodException e) {
                throw new RuntimeException("Bean error: " + e.getMessage(), e);
            } catch (final IllegalAccessException e) {
    ...
    private static class NotImplementedYet extends AbstractValueHandler {
        ...
        @Override
        public void parse(final String line, final int startpos,
                final Stack stack) throws IOException {
