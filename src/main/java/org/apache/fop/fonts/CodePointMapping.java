...
public class CodePointMapping extends AbstractCodePointMapping {
    ...
    public CodePointMapping(final String name, final int[] table) {
        super(name, table);
    }
    ...
    private static Map<String, CodePointMapping> mappings;
    static {
        mappings = Collections
                .synchronizedMap(new HashMap<String, CodePointMapping>());
    }

    public static CodePointMapping getMapping(final String encoding) {
        CodePointMapping mapping = mappings.get(encoding);
        if (mapping != null) {
            return mapping;
        }

        else if (encoding.equals(STANDARD_ENCODING)) {
            mapping = new CodePointMapping(STANDARD_ENCODING,
                    encStandardEncoding, namesStandardEncoding);
            mappings.put(STANDARD_ENCODING, mapping);
            return mapping;
        }

        else if (encoding.equals(ISOLATIN1_ENCODING)) {
            mapping = new CodePointMapping(ISOLATIN1_ENCODING,
                    encISOLatin1Encoding, namesISOLatin1Encoding);
            mappings.put(ISOLATIN1_ENCODING, mapping);
            return mapping;
        }

        else if (encoding.equals(CE_ENCODING)) {
            mapping = new CodePointMapping(CE_ENCODING, encCEEncoding,
                    namesCEEncoding);
            ...
            mapping = new CodePointMapping(MAC_ROMAN_ENCODING,
                    encMacRomanEncoding, namesMacRomanEncoding);
            mappings.put(MAC_ROMAN_ENCODING, mapping);
            return mapping;
        }

        else if (encoding.equals(WIN_ANSI_ENCODING)) {
            mapping = new CodePointMapping(WIN_ANSI_ENCODING,
                    encWinAnsiEncoding, namesWinAnsiEncoding);
            mappings.put(WIN_ANSI_ENCODING, mapping);
            return mapping;
        }

        else if (encoding.equals(PDF_DOC_ENCODING)) {
            mapping = new CodePointMapping(PDF_DOC_ENCODING, encPDFDocEncoding,
                    namesPDFDocEncoding);
            ...
            mapping = new CodePointMapping(SYMBOL_ENCODING, encSymbolEncoding,
                    namesSymbolEncoding);
            ...
            mapping = new CodePointMapping(ZAPF_DINGBATS_ENCODING,
                    encZapfDingbatsEncoding, namesZapfDingbatsEncoding);
    ...
    private static final int[] encStandardEncoding = { 0x20, 0x0020, // space
            0x20, 0x00A0, // space
            0x21, 0x0021, // exclam
    ...
    private static final int[] encISOLatin1Encoding = { 0x20, 0x0020, // space
            0x20, 0x00A0, // space
            0x21, 0x0021, // exclam
            0x22, 0x0022, // quotedbl
            0x23, 0x0023, // numbersign
    ...
    private static final int[] encCEEncoding = { 0x20, 0x0020, // space
            0x20, 0x00A0, // space
            0x21, 0x0021, // exclam
            0x22, 0x0022, // quotedbl
            0x23, 0x0023, // numbersign
    ...
    private static final int[] encMacRomanEncoding = { 0x20, 0x0020, // space
            0x20, 0x00A0, // space
            0x21, 0x0021, // exclam
            0x22, 0x0022, // quotedbl
            0x23, 0x0023, // numbersign
    ...
    private static final int[] encWinAnsiEncoding = { 0x20, 0x0020, // space
            0x20, 0x00A0, // space
            0x21, 0x0021, // exclam
            0x22, 0x0022, // quotedbl
            0x23, 0x0023, // numbersign
    ...
    private static final int[] encPDFDocEncoding = { 0x18, 0x02D8, // breve
            0x19, 0x02C7, // caron
    ...
    private static final int[] encSymbolEncoding = { 0x20, 0x0020, // space
            0x20, 0x00A0, // space
            0x21, 0x0021, // exclam
    ...
    private static final int[] encZapfDingbatsEncoding = { 0x20, 0x0020, // space
            0x20, 0x00A0, // space
            0x21, 0x2701, // a1
            0x22, 0x2702, // a2
            0x23, 0x2703, // a202
    ...
    private static final String[] namesStandardEncoding = {
        ...
        /* B8 */"quotesinglbase", "quotedblbase", "quotedblright",
        "guillemotright",
    ...
    private static final String[] namesSymbolEncoding = {
        ...
        /* F8 */"parenrightbt", "bracketrighttp", "bracketrightex",
        "bracketrightbt",
