 ...
 public class FontInfo {
     ...
     * @return the requested Font instance
     ...
     public Font getFontInstance(final FontTriplet triplet, final int fontSize) {
         ...
         final Integer size = Integer.valueOf(fontSize);
     ...
     private List<FontTriplet> getTripletsForName(final String fontName) {
         final List<FontTriplet> matchedTriplets = new ArrayList<FontTriplet>();
     ...
     * @return the font triplet of the font chosen
     ...
     private List<FontTriplet> fontLookup(final String[] families,
         ...
         final List<FontTriplet> matchingTriplets = new ArrayList<FontTriplet>();
     ...
     *            a SVG font family
      */
     public void notifyStrokingSVGTextAsShapes(final String fontFamily) {
         if (this.eventListener != null) {
     ...
     * @return font metrics
     ...
     public FontMetrics getMetricsFor(final String fontName) {
         final Typeface metrics = this.fonts.get(fontName);
     ...
     * @return A list of matching font triplets
     ...
     public List<FontTriplet> getTripletsFor(final String fontName) {
         final List<FontTriplet> foundTriplets = new ArrayList<FontTriplet>();
         for (final Map.Entry<FontTriplet, String> tripletEntry : this.triplets
                .entrySet()) {
     ...
     * @return font weight
     ...
     public String toString() {
         final SortedSet<String> entries = new TreeSet<String>();
         for (final FontTriplet triplet : this.triplets.keySet()) {
