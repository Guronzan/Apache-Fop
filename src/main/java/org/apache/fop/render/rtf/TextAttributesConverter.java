...
/* $Id: TextAttributesConverter.java 1297284 2012-03-05 23:29:29Z gadams $ */
 ...
 * Boris Poudérous (boris.pouderous@eads-telecom.com), Peter Herweg
 * (pherweg@web.de), Normand Massé, Christopher Scott
 * (scottc@westinghouse.com), and Roberto Marra (roberto@link-u.com).
 * </p>
 */
@Slf4j
 final class TextAttributesConverter {
    ...
    /**
      ...
      * 
     * @param fobj
     *            the FO for which the attributes are to be converted
      */
     ...
     private static void attrBreak(final Block fobj,
            final FOPRtfAttributes attrib) {
         final int breakValue = fobj.getBreakBefore();
     ...
     */
      ...
      *
      * @param bpb
     *            the CommonBorderPaddingBackground from which the properties
     *            are read
     * @param rtfAttr
