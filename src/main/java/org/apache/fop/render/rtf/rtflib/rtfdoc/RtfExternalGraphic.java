...
/* $Id: RtfExternalGraphic.java 681307 2008-07-31 09:06:10Z jeremias $ */
 ...
 * <fo:external-graphic> tag processing. <br>
 *
 * Supports relative path like "../test.gif", too (01-08-24) <br>
 *
 * Limitations: <li>Only the image types PNG, JPEG and EMF are supported <li>The
 * GIF is supported, too, but will be converted to JPG <li>Only the attributes
 * SRC (required), WIDTH, HEIGHT, SCALING are supported <li>The SCALING
 * attribute supports (uniform | non-uniform)
 *
 * Known Bugs: <li>If the emf image has a desired size, the image will be
 * clipped <li>The emf, jpg & png image will not be displayed in correct size
 *
...
public class RtfExternalGraphic extends RtfElement {
    ...
    public static class ExternalGraphicException extends IOException {
         ...
         *
         */
        private static final long serialVersionUID = 863688799073897301L;
