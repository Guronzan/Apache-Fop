...
public class PercentContext implements PercentBaseContext {
    ...
    private final Map<FObj, Integer> lengthMap = new HashMap<>();

    /** Map containing the Tables and their table units */
    private final Map<Table, Integer> tableUnitMap = new HashMap<>();
    ...
    public int getBaseLength(final int lengthBase, FObj fobj) {
        ...
        case LengthBase.TABLE_UNITS:
            ...
            return 0;
        default:
            log.error("Unsupported base type for LengthBase", new Exception(
                    "Unsupported base type for LengthBase:" + lengthBase));
            return 0;
        }
    }
