 ...
 *
 * @author Art Welch
 * @author <a href="mailto:mark-fop@inomial.com">Mark Lillywhite</a> (to use the
...
public class TXTRenderer extends AbstractPathOrientedRenderer<PSState> {
    ...
    protected void renderText(final TextArea area) {
        ...
        final int row = Helper
                .ceilPosition(this.currentBPPosition, CHAR_HEIGHT);
    ...
    public void renderImage(final Image image, final Rectangle2D pos) {
        ...
        final int y1 = Helper.ceilPosition(this.currentBPPosition, CHAR_HEIGHT);
    ...
    protected void drawBackAndBorders(final Area area, final float startx,
        ...
        this.bm.setHeight(Helper.ceilPosition(toMilli(height), CHAR_HEIGHT));
        this.bm.setStartX(Helper.ceilPosition(toMilli(startx), CHAR_WIDTH));
        this.bm.setStartY(Helper.ceilPosition(toMilli(starty), CHAR_HEIGHT));
