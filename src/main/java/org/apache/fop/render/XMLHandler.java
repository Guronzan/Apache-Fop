...
/**
 * This interface is implemented by classes that can handle a certain type of
 * foreign objects.
 */
public interface XMLHandler {
     ...
     * </p>
     * <p>
     * The implementation may convert the XML document internally to another XML
     * dialect (SVG, for example) and call renderXML() on the AbstractRenderer
     ...
     * @param doc
     *            A DOM containing the foreign object to be processed
     * @param ns
     *            The Namespace of the foreign object
     * @exception Exception
     *                If an error occurs during processing.
     */
    void handleXML(final RendererContext context, final Document doc,
            final String ns) throws Exception;

    /**
     * Checks if this XMLHandler supports handling an XML namespace for a
     * particular renderer.
     * 
     * @param renderer
     ...
     */
    boolean supportsRenderer(final Renderer renderer);
