...
public class PDFImageHandlerRawJPEG implements PDFImageHandler, ImageHandler {
    ...
    public PDFXObject generateImage(final RendererContext context,
        ...
        final PDFImage pdfimage = new ImageRawJPEGAdapter(jpeg, image.getInfo()
                .getOriginalURI());
    ...
    public void handleImage(final RenderingContext context, final Image image,
        ...
        final ImageRawJPEG imageJPEG = (ImageRawJPEG) image;

        final PDFImage pdfimage = new ImageRawJPEGAdapter(imageJPEG, image
