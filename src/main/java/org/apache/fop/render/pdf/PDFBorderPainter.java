...
public class PDFBorderPainter extends BorderPainter {
    ...
    /** {@inheritDoc} */
    public static void drawBorderLine(final PDFContentGenerator generator,
        ...
        case Constants.EN_RIDGE: {
            final float colFactor = style == Constants.EN_GROOVE ? 0.4f : -0.4f;
            generator.add("[] 0 d ");
            if (horz) {
        ...
        case Constants.EN_OUTSET: {
            final float colFactor = style == Constants.EN_OUTSET ? 0.4f : -0.4f;
            generator.add("[] 0 d ");
            Color c = col;
            if (horz) {
