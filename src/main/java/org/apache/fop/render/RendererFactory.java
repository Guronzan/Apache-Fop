...
public class RendererFactory {
    ...
    private final Map rendererMakerMapping = new HashMap<>();
    private final Map eventHandlerMakerMapping = new HashMap<>();
    private final Map documentHandlerMakerMapping = new HashMap<>();
    ...
    public String[] listSupportedMimeTypes() {
        ...
        Iterator<String> iter = this.rendererMakerMapping.keySet().iterator();
        while (iter.hasNext()) {
            lst.add(iter.next());
        }
