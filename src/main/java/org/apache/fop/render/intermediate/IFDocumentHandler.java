...
public interface IFDocumentHandler {
     ...
     *            the context object
     */
    void setContext(final IFContext context);
     ...
     */
    void setResult(final Result result) throws IFException;
     ...
     */
    void setFontInfo(final FontInfo fontInfo);
     ...
     */
    void setDefaultFontInfo(final FontInfo fontInfo);
    ...
    /**
     * Indicates whether the painter supports to handle the pages in mixed order
    ...
    /**
     * Returns the MIME type of the output format that is generated by this
     * implementation.
     * 
    ...
    /**
     * Indicates the start of a document. This method may only be called once
     * before any other event method.
     * 
     * @throws IFException
    ...
    /**
     * Indicates the end of a document. This method may only be called once
     * after the whole document has been handled. Implementations can release
     * resources (close streams). It is an error to call any event method after
     * this method.
     * 
     * @throws IFException
     *             if an error occurs while handling this event
    ...
    /**
     * Indicates the start of the document header. This method is called right
     * after the {@link #startDocument()} method. Extensions sent to this
     * painter between {@link #startDocumentHeader()} and
     * {@link #endDocumentHeader()} apply to the document as a whole (like
     * document metadata).
     * 
     * @throws IFException
     *             if an error occurs while handling this event
    ...
    /**
     * Indicates the end of the document header. This method is called before
    ...
    /**
     * Indicates the start of the document trailer. This method is called after
     * the last page sequence. Extensions sent to the painter between
     * {@link #startDocumentTrailer()} and {@link #endDocumentTrailer()} apply
     * to the document as a whole and is used for document-level content that is
     * only known after all pages have been rendered (like named destinations or
     * the bookmark tree).
     * 
     * @throws IFException
     *             if an error occurs while handling this event
    ...
    /**
     * Indicates the end of the document trailer. This method is called right
     * before the {@link #endDocument()} method.
     * 
     * @throws IFException
     *             if an error occurs while handling this event
     */
     ...
     *             if an error occurs while handling this event
     */
    void startPageSequence(final String id) throws IFException;
     ...
     * @param name
     *            the page name (usually the formatted page number)
     * @param pageMasterName
     *            the name of the simple-page-master that generated this page
     * @param size
     *            the size of the page (equivalent to the MediaBox in PDF)
     * @throws IFException
     *             if an error occurs while handling this event
     */
    void startPage(final int index, final String name,
    ...
    /**
     * Indicates the start of the page content. The method returns an
     * {@link IFPainter} interface which is used to paint the page contents.
     * 
     * @throws IFException
     *             if an error occurs while handling this event
    ...
    /**
     * Indicates the end of the page content. Calls to the {@link IFPainter}
     * returned by the respective {@link #startPageContent()} method are
     * illegal.
     * 
     * @throws IFException
     *             if an error occurs while handling this event
    ...
    /**
     * Indicates the start of the page trailer. The page trailer is used for
     * writing down page elements which are only know after handling the page
     * itself (like PDF targets).
     * 
     * @throws IFException
     *             if an error occurs while handling this event
     */
     ...
     * object. If an implementation doesn't know how to handle a particular
     * extension it is simply ignored.
     * 
     * @param extension
     ...
     *             if an error occurs while handling this event
     */
    void handleExtensionObject(final Object extension) throws IFException;
