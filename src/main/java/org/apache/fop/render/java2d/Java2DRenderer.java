...
AbstractPathOrientedRenderer<Java2DGraphicsState> implements Printable {
    ...
    public void setUserAgent(final FOUserAgent foUserAgent) {
        ...
        this.userAgent.setRendererOverride(this); // for document regeneration

        final String s = (String) this.userAgent.getRendererOptions().get(
    ...
    public void renderText(final TextArea text) {
        ...
        final Typeface tf = (Typeface) this.fontInfo.getFonts().get(
                font.getFontName());
