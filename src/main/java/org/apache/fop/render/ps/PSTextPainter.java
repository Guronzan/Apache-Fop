 ...
 * draws the text directly using PostScript text operators so the text is not
 * drawn using shapes which makes the PS files larger.
 * <p>
...
public class PSTextPainter extends NativeTextPainter {
    ...
    private PSResource getResourceForFont(final Font f, final String postfix) {
    ...
    private class TextUtil {
        ...
        public void selectFont(final Font f, final char mapped)
            ...
            final String postfix = encoding == 0 ? null : Integer
                    .toString(encoding);
            final PSResource res = getResourceForFont(f, postfix);
