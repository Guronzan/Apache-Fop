...
/* $Id: PSBorderPainter.java 820672 2009-10-01 14:48:27Z jeremias $ */
...
public class PSBorderPainter extends BorderPainter {
    ...
    /** {@inheritDoc} */
    @Override
    protected void drawBorderLine(final int x1, final int y1, final int x2,
            final int y2, final boolean horz, final boolean startOrBefore,
            final int style, final Color col) throws IOException {
    ...
    private static void drawLine(final PSGenerator gen, final float startx,
        ...
        gen.writeln(gen.formatDouble(startx) + " " + gen.formatDouble(starty)
                + " M " + gen.formatDouble(endx) + " " + gen.formatDouble(endy)
                + " lineto stroke newpath");
    }

    /** {@inheritDoc} */
    public static void drawBorderLine(final PSGenerator gen, final float x1,
            final float y1, final float x2, final float y2, final boolean horz,
    ...
    protected void moveTo(final int x, final int y) throws IOException {
        this.generator.writeln(this.generator.formatDouble(toPoints(x)) + " "
                + this.generator.formatDouble(toPoints(y)) + " M");
    }
    ...
    protected void lineTo(final int x, final int y) throws IOException {
        this.generator.writeln(this.generator.formatDouble(toPoints(x)) + " "
                + this.generator.formatDouble(toPoints(y)) + " lineto");
    }
