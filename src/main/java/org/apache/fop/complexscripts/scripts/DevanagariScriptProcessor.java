...
/**
 * <p>
 * The <code>DevanagariScriptProcessor</code> class implements a script
 * processor for performing glyph substitution and positioning operations on
 * content associated with the Devanagari script.
 * </p>
 *
 * <p>
...
@Slf4j
 public class DevanagariScriptProcessor extends IndicScriptProcessor {
    ...
    DevanagariScriptProcessor(final String script) {
         super(script);
     }
     ...
     private static class DevanagariSyllabizer extends DefaultSyllabizer {
         DevanagariSyllabizer(final String script, final String language) {
     ...
     static final int ccaStart = 0x0900; // first code point mapped by cca //
                                        // CSOK: ConstantNameCheck
     static final int ccaEnd = 0x0980; // last code point + 1 mapped by cca //
                                      // CSOK: ConstantNameCheck
    ...
    C_O, // 0x0900 // INVERTED CANDRABINDU
            ...
            C_C | C_R | C_N, // 0x0931 // RRA = 0930+093C // CSOK:
                             // WhitespaceAround
            C_C, // 0x0932 // LA
            C_C, // 0x0933 // LLA
            C_C, // 0x0934 // LLLA
