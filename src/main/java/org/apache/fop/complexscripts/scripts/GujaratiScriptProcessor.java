...
/**
 * <p>
 * The <code>GujaratiScriptProcessor</code> class implements a script processor
 * for performing glyph substitution and positioning operations on content
 * associated with the Gujarati script.
 * </p>
 *
 * <p>
...
@Slf4j
 public class GujaratiScriptProcessor extends IndicScriptProcessor {
    ...
    GujaratiScriptProcessor(final String script) {
         super(script);
     }
     ...
     private static class GujaratiSyllabizer extends DefaultSyllabizer {
         GujaratiSyllabizer(final String script, final String language) {
     ...
     static final int ccaStart = 0x0A80; // first code point mapped by cca //
                                        // CSOK: ConstantNameCheck
     static final int ccaEnd = 0x0B00; // last code point + 1 mapped by cca //
                                      // CSOK: ConstantNameCheck
