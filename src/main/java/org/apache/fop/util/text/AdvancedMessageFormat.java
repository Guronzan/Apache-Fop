...
/* $Id: AdvancedMessageFormat.java 679326 2008-07-24 09:35:34Z vhennebert $ */
 ...
 * is similar to {@link java.util.MessageFormat} but uses named parameters and
...
public class AdvancedMessageFormat {
    ...
    private int parseInnerPattern(final CharSequence pattern,
            final CompositePart parent, final StringBuilder sb, final int start) {
        assert sb.length() == 0;
        int i = start;
     ...
     *            a Map of named parameters (Contents: <String, Object>)
     * @param target
     *            the target StringBuilder to write the formatted message to
     */
    ...
    public interface Part {
         ...
         */
        void write(final StringBuilder sb, final Map<String, Object> params);
    ...
    public interface ObjectFormatter {
         ...
         */
        void format(final StringBuilder sb, final Object obj);
     ...
     *            the target string buffer
     */
    public static void formatObject(final Object obj, final StringBuilder target) {
        if (obj instanceof String) {
            target.append(obj);
        } else {
            boolean handled = false;
            final Iterator iter = OBJECT_FORMATTERS.iterator();
            while (iter.hasNext()) {
                final ObjectFormatter formatter = (ObjectFormatter) iter.next();
    ...
    private static class CompositePart implements Part {
        ...
        public void write(final StringBuilder sb,
            ...
            if (this.hasSections) {
                ...
                while (iter.hasNext()) {
                    final CompositePart part = (CompositePart) iter.next();
