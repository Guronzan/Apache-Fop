...
/**
 * This class contains utility methods for conversions, like a java.lang.String
 * to an array of int or double.
 */
public final class ConversionUtils {

    /**
     * Converts the given base <code>String</code> into an array of
     * <code>int</code>, splitting the base along the given separator pattern.
     ...
     *            the pattern separating the integer values (if this is
     *            <code>null</code>, the baseString is parsed as one integer
     *            value)
     * @return an array of <code>int</code> whose size is equal to the number
     *         values in the input string; <code>null</code> if this number is
     *         equal to zero.
     */
    public static int[] toIntArray(final String baseString,
        ...
        final String[] values = baseString.split(separatorPattern);
        final int numValues = values.length;
        if (numValues == 0) {
            return null;
        }

        final int[] returnArray = new int[numValues];
    ...
    /**
     * Converts the given base <code>String</code> into an array of
     * <code>double</code>, splitting the base along the given separator
     * pattern. <em>Note: this method assumes the input is a string containing
     ...
     * @param separatorPattern
     *            the pattern separating the integer values (if this is
     *            <code>null</code>, the baseString is parsed as one double
     *            value)
     * @return an array of <code>double</code> whose size is equal to the number
     *         values in the input string; <code>null</code> if this number is
     *         equal to zero.
     */
    public static double[] toDoubleArray(final String baseString,
            final String separatorPattern) {
        ...
        final double[] returnArray = new double[numValues];
        for (int i = 0; i < numValues; ++i) {
