...
public class BitmapImageUtil {
     ...
     */
    public static final boolean isMonochromeImage(final RenderedImage img) {
     ...
     *         white/bright pixel
     */
    public static final boolean isZeroBlack(final RenderedImage img) {
     ...
     */
    public static final int convertToGray(final int r, final int g, final int b) {
     ...
     * @return the gray value
     */
    public static final int convertToGray(final int rgb) {
     ...
     */
    public static final int getColorIndexSize(final RenderedImage img) {
     ...
     */
    public static final boolean isGrayscaleImage(final RenderedImage img) {
     ...
     */
    public static final BufferedImage convertTosRGB(final RenderedImage img,
     ...
     */
    public static final BufferedImage convertToGrayscale(
     ...
     */
    public static final BufferedImage convertToMonochrome(
            final RenderedImage img, final Dimension targetDimension) {
     ...
     * @return the monochrome image
     */
    public static final RenderedImage convertToMonochrome(
            final RenderedImage img, final Dimension targetDimension,
            final float quality) {
        if (!isMonochromeImage(img)) {
            if (quality >= 0.5f) {
