...
/**
 * This class is meant for supporting the Unicode line breaking algorithm. See:
 * <a href="http://unicode.org/reports/tr14/">UTR 14</a>
 *
 */
public class LineBreakStatus {
    ...
    /**
     * Resets the class to the same state as if new LineBreakStatus() had just
     * been called.
     */
    ...
    /**
     * Reset the status. This method will reset the status to the initial state.
     * It is meant for recycling objects.
     */
    public void reset() {
        this.leftClass = -1;
        this.hadSpace = false;
     ...
     * the <a href="http://unicode.org/reports/tr14/#Algorithm">Unicode Line
     * Breaking Algorithm</a>. The function returns the line breaking status of
     * the point <em>before</em> the given character. The algorithm is the
     * table-driven algorithm, as described in <a
     * href="http://unicode.org/reports/tr14/#PairBasedImplementation"> Unicode
     * Technical Report #14</a>. The pair table is taken from
     * {@link LineBreakUtils}.
     *
     ...
     * @return the break action to be taken one of: {@link #DIRECT_BREAK},
     *         {@link #INDIRECT_BREAK}, {@link #COMBINING_INDIRECT_BREAK},
     *         {@link #COMBINING_PROHIBITED_BREAK}, {@link #PROHIBITED_BREAK},
     *         {@link #EXPLICIT_BREAK}
     */
    public byte nextChar(final char c) {
        ...
        /*
         * Check 1: First character or initial character after a reset/mandatory
         * break?
         */
        ...
        case -1:
            ...
            if (this.leftClass == LineBreakUtils.LINE_BREAK_PROPERTY_CM) {
                // LB 10: Treat any remaining combining marks as AL
                this.leftClass = LineBreakUtils.LINE_BREAK_PROPERTY_AL;
            }
        ...
        case LineBreakUtils.LINE_BREAK_PROPERTY_CR:
            ...
            // LB 5: Treat CR followed by LF, as well as CR ... as hard line
            // breaks
            // If current is LF, then fall through to Check 2 (see below),
            // and the hard break will be signaled for the character after LF
            // (see above)
        ...
        final boolean savedHadSpace = this.hadSpace;
        this.hadSpace = false;
        final byte breakAction = LineBreakUtils.getLineBreakPairProperty(
                this.leftClass, currentClass);
        switch (breakAction) {
     ...
     */
    /*
     * public static void main(String args[]) { LineBreakStatus lbs = new
     * LineBreakStatus(); lbs.nextChar('\n'); lbs.nextChar('\n');
     * lbs.nextChar('x'); }
     */
}
