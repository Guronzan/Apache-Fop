...
public class InlineLayoutManager extends InlineStackingLayoutManager {
        ...
        while ((curLM = getChildLM()) != null) {
            ...
            if (curLM instanceof InlineLevelLayoutManager) {
                ...
                if (!borderAdded && !returnedList.isEmpty()) {
                    addKnuthElementsForBorderPaddingStart((KnuthSequence) returnedList
                            .get(0));
                    borderAdded = true;
                }
                for (final Iterator iter = returnedList
    ...
    public void addAreas(final PositionIterator parentIter,
        ...
        /*
         * if (pos != null) { lastLM = pos.getPosition().getLM(); }
         */
        ...
        if (parent instanceof InlineParent) {
            ...
            if (this.borderProps != null) {
                parent.setOffset(this.borderProps.getPaddingBefore(false, this)
    ...
    protected Position getAuxiliaryPosition() {
        ...
        // this.auxiliaryPosition = new NonLeafPosition(this, new
        // LeafPosition(this, -1));
