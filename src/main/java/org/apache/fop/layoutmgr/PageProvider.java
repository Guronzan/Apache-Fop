...
@Slf4j
 public class PageProvider implements Constants {
     ...
     */
     ...
     private final List<Page> cachedPages = new java.util.ArrayList<Page>();
     ...
     * @param spanAll
     *            true if the current element list is for a column-spanning
     *            section
      */
     public void setStartOfNextElementList(final int startPage,
            final int startColumn, final boolean spanAll) {
         if (log.isDebugEnabled()) {
             log.debug("start of the next element list is:" + " page="
     ...
     * @return a Page instance
     ...
     private Page cacheNextPage(final int index, final boolean isBlank,
            final boolean isLastPage, final boolean spanAll) {
