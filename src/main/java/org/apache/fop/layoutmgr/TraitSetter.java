...
public class TraitSetter {
    ...
    public static void setBorderPaddingTraits(final Area area,
            ...
            final boolean bNotFirst, final boolean bNotLast,
    ...
    private static void addBorderTrait(final Area area,
            final CommonBorderPaddingBackground bpProps,
            final boolean bDiscard, final int iSide, final int mode,
            final Integer oTrait) {
        final int iBP = bpProps.getBorderWidth(iSide, bDiscard);
        if (iBP > 0) {
            area.addTrait(
                    oTrait,
                    new BorderProps(bpProps.getBorderStyle(iSide), iBP, bpProps
    ...
    private static void addPadding(final Area area,
            final CommonBorderPaddingBackground bordProps,
            final PercentBaseContext context) {
    ...
    private static BorderProps getCollapsingBorderProps(
        ...
        if (width != 0) {
            final BorderProps bps = new BorderProps(borderInfo.getStyle(),
                    width, borderInfo.getColor(),
     ...
     *            string
     */
    public static void addPtr(final Area area, final String ptr) {
