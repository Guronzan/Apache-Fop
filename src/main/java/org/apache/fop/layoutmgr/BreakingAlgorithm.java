...
public abstract class BreakingAlgorithm {
    ...
    public class KnuthNode {
        ...
        public KnuthNode(final int position, final int line, final int fitness,
     ...
     */
    protected void forceNode(final KnuthNode node, final int line,
            final int elementIdx, final int difference, final double r,
            final double demerits, final int fitnessClass,
            final int availableShrink, final int availableStretch) {
