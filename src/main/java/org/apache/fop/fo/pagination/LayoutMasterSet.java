...
public class LayoutMasterSet extends FObj {
    ...
    private void resolveSubSequenceReferences() throws ValidationException {
        for (final PageSequenceMaster psm : this.pageSequenceMasters.values()) {
            for (final SubSequenceSpecifier subSequenceSpecifier : psm
                    .getSubSequenceSpecifier()) {
    ...
    public boolean regionNameExists(final String regionName) {
        for (final SimplePageMaster spm : this.simplePageMasters.values()) {
