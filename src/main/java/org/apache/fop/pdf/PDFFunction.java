...
public class PDFFunction extends PDFObject {
    ...
    /**
     * Required: 2 * n Array of Double numbers which are possible outputs to the
     * function
     */
    ...
    /**
     * Required: Array containing the Integer size of the Domain and Range,
     * respectively. Note: This is really more like two seperate integers,
     * sizeDomain, and sizeRange, but since they're expressed as an array in
     * PDF, my implementation reflects that.
     */
     ...
     * domain of the corresponding function. Should be two values per function,
     * usually (0,1), as in [0 1 0 1] for 2 functions.
     */
     ...
     * filters to be used to decode the stream. These are how the string is
     * compressed. Flate, LZW, etc.
     */
    ...
    /**
     * Required for Type 2: The interpolation exponent. Each value x will return
     * n results. Must be greater than 0.
     */
    ...
    /**
     * Required for Type 3: An vector of PDFFunctions which form an array of k
     ...
     * Domain, define the intervals to which each function from the Functions
     * array apply. Bounds elements must be in order of increasing magnitude,
     * and each value must be within the value of Domain. k is the number of
     * functions. If you pass null, it will output (1/k) in an array of k-1
     * elements. This makes each function responsible for an equal amount of the
     * stitching function. It makes the gradient even.
     */
     ...
     *            An int specifying the number of bits used to represent each
    ...
    /**
     * create an complete Function object of Type 2, an Exponential
     ...
     */
    public PDFFunction(final int theFunctionType, final List theDomain,
            final List theRange, final List theCZero, final List theCOne,
            final double theInterpolationExponentN) {
        super();
     ...
     *            function. See page 264 of the PDF 1.3 Spec.
     * @param theFunctions
     *            A List of the PDFFunction objects that the stitching function
     *            stitches.
     *
     ...
     */
    public PDFFunction(final int theFunctionType, final List theDomain,
            final List theRange, final List theFunctions, final List theBounds,
            final List theEncode) {
        super();
    ...
    /**
     * create an complete Function object of Type 4, a postscript calculator
     * function.
     *
     * Use null for an optional object parameter if you choose not to use it.
     * For optional int parameters, pass the default.
     *
     * @param theDomain
     *            List object of Double objects. This is the domain of the
     *            function. See page 264 of the PDF 1.3 Spec.
     * @param theRange
     *            List object of Double objects. This is the Range of the
     *            function. See page 264 of the PDF 1.3 Spec.
     * @param theFunctionDataStream
     *            This is a stream of arithmetic, boolean, and stack operators
     *            and boolean constants. I end up enclosing it in the '{' and
     *            '}' braces for you, so don't do it yourself.
     *
     *            This attribute is required. It's described on page 269 of the
     *            PDF 1.3 spec.
     * @param theFunctionType
     *            The type of function which should be 4, as this is a
    ...
    public byte[] toPDF() {
        ...
        if (this.functionType == 0) {
            if (this.domain != null) {
                ...
                for (tempInt = 0; tempInt < vectorSize; tempInt++) {
                    p.append(PDFNumber.doubleOut((Double) this.domain
                            .get(tempInt)) + " ");
                }
            ...
            if (this.size != null) {
                ...
                for (tempInt = 0; tempInt < vectorSize; tempInt++) {
                    p.append(PDFNumber.doubleOut((Double) this.size
                            .get(tempInt)) + " ");
                }
                p.append("] \n");
            }
            ...
            if (this.encode != null) {
                ...
                for (tempInt = 0; tempInt < vectorSize; tempInt++) {
                    p.append(PDFNumber.doubleOut((Double) this.encode
                            .get(tempInt)) + " ");
                }
                p.append("] \n");
            } else {
            ...
            if (this.range != null) {
                ...
                for (tempInt = 0; tempInt < vectorSize; tempInt++) {
                    p.append(PDFNumber.doubleOut((Double) this.range
                            .get(tempInt)) + " ");
                }
            ...
            if (this.decode != null) {
                ...
                for (tempInt = 0; tempInt < vectorSize; tempInt++) {
                    p.append(PDFNumber.doubleOut((Double) this.decode
                            .get(tempInt)) + " ");
                }
            ...
            if (this.cZero != null) {
                ...
                for (tempInt = 0; tempInt < vectorSize; tempInt++) {
                    p.append(PDFNumber.doubleOut((Double) this.cZero
                            .get(tempInt)) + " ");
                }
                p.append("] \n");
            }
            ...
            if (this.cOne != null) {
                ...
                for (tempInt = 0; tempInt < vectorSize; tempInt++) {
                    p.append(PDFNumber.doubleOut((Double) this.cOne
                            .get(tempInt)) + " ");
                }
                p.append("] \n");
            }
        ...
        } else if (this.functionType == 3) { // fix this up when my eyes uncross
            // DOMAIN
            if (this.domain != null) {
                p.append("/Domain [ ");
                vectorSize = this.domain.size();
            ...
            if (this.functions != null) {
                ...
                for (tempInt = 0; tempInt < numberOfFunctions; tempInt++) {
                    p.append(((PDFFunction) this.functions.get(tempInt))
                            .referencePDF() + " ");
            ...
            if (this.bounds != null) {
                ...
                for (tempInt = 0; tempInt < vectorSize; tempInt++) {
                    p.append(PDFNumber.doubleOut((Double) this.bounds
                            .get(tempInt)) + " ");
                }
                ...
                if (this.functions != null) {
                    ...
                    String functionsFraction = PDFNumber.doubleOut(new Double(
                            1.0 / numberOfFunctions));
            ...
            p.append(">> \nendobj\n");
        } else if (this.functionType == 4) { // fix this up when my eyes uncross
            // DOMAIN
            if (this.domain != null) {
                p.append("/Domain [ ");
                vectorSize = this.domain.size();
    ...
    protected boolean contentEquals(final PDFObject obj) {
        ...
        final PDFFunction func = (PDFFunction) obj;
        if (this.functionType != func.functionType) {
            return false;
        }
        if (this.bitsPerSample != func.bitsPerSample) {
            return false;
        }
        if (this.order != func.order) {
            return false;
        }
        if (this.interpolationExponentN != func.interpolationExponentN) {
            return false;
        }
        if (this.domain != null) {
